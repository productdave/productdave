...
| **[Job Search OS](https://github.com/productdave/Job-Search-OS)** · agentic workflow for job search | Most job searches repeat the same work and throw away every outcome. This pair of agent skills finds and verifies roles, tailors truthful resumes, tracks results, and learns which positioning earns callbacks. **Open source** |
